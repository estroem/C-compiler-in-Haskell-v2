...
toAsmLine (Setnz reg)                = ["setnz " ++ getRegLower reg]
...
toAsmLine (Seta reg)                 = ["seta " ++ getRegLower reg]
toAsmLine (Setb reg)                 = ["setb " ++ getRegLower reg]
toAsmLine (Setae reg)                = ["setae " ++ getRegLower reg]
toAsmLine (Setbe reg)                = ["setbe " ++ getRegLower reg]
...
toAsmLine (Fcom)                     = ["fcom"]
toAsmLine (FnstswAx)                 = ["fnstsw ax"]
toAsmLine (Sahf)                     = ["sahf"]
toAsmLine (TestFloat reg)            = ["test ah, 41h"]
